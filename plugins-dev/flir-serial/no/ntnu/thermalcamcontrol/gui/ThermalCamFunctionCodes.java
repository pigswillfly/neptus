...
public enum ThermalCamFunctionCodes{
    ...
    SERIAL_NUMBER(0x04, 0, 8, "Serial number request. "
            + "Reply bytes 0-3 camera, 4-7 sensor serial#", "StatusPanel", null),
    GET_REVISION(0x05, 0, 8, "Get software / firmware revision. "
            + "Reply 2 bytes ea: sw maj/min, fw maj/min", "StatusPanel", null),
    ...
    AGC_TYPE_GET(0x13, 0, 2, "Get AGC algorithm", "AgcModesPanel", null),
    AGC_TYPE_SET(0x13, 2, 2, "Set AGC algorithm", "AgcModesPanel", null),
    AGC_SUB_GET(0x13, 2, 2, "AGC sub functions", "AgcModesPanel", null),
    AGC_SUB_SET(0x13, 4, 0, "AGC sub functions", "AgcModesPanel", null),
    CONTRAST_GET(0x14, 0, 2, "Get contrast value used by once-bright, auto-bright and manual"
            + "AGC algorithms", "ManualParamPanel", null),
    CONTRAST_SET(0x14, 2, 2, "Set contrast value used by once-bright, auto-bright and manual"
            + "AGC algorithms", "ManualParamPanel", null),
    BRIGHTNESS_GET(0x15, 0, 2, "Get brightness value used by manual and auto-bright AGC", "ManualParamPanel", null),
    BRIGHTNESS_SET(0x15, 2, 2, "Set brightness value used by manual and auto-bright AGC", "ManualParamPanel", null),
    ...
    ACE_CORRECT_GET(0x1C, 0, 2, "Get the Active Contrast Enhancement Correction for AGC", "EnhancePanel", null),
    ACE_CORRECT_SET(0x1C, 2, 2, "Set the Active Contrast Enhancement Correction for AGC", "EnhancePanel", null),
    ...
    DDE_GAIN_GET(0x2C, 0, 2, "Get gain value for DDE in manual mode", "EnhancePanel", null),
    DDE_GAIN_SET(0x2C, 2, 2, "Set gain value for DDE in manual mode", "EnhancePanel", null),
    ...
    AGC_ROI_GET(0x4C, 0, 8, "Gets the region of interest", "RoiPanel", null),
    AGC_ROI_SET(0x4C, 8, 8, "Sets the region of interest", "RoiPanel", null),
    ...
    AGC_MIDPOINT_SET(0x55, 2, 2, "Set the AGC midpoint offset for plateau-equalization "
            + "and linear AGC algs", "ThermalCamControlGui", null),
    SERIAL_NUMBER_GET_REDUNDANT(0x65, 0, 8, "Get serial number of cam and sensor", "StatusPanel", null),
    CAMERA_PART_GET(0x66, 0, 32, "Get camera part. Reply in ASCII", "StatusPanel", null),
