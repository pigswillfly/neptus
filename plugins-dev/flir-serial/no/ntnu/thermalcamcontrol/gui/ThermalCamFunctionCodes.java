...
public enum ThermalCamFunctionCodes{
    ...
    SET_DEFAULTS(0x01, 0, 0, "Set defaults non-blocking", "ThermalCamControlGui", null),
    CAMERA_RESET(0x02, 0, 0, "Reset / reboot", "ThermalCamControlGui", null),
    RESTORE_FACTORY_DEFAULTS(0x03, 0, 0, "Revert to factory defaults", "ThermalCamControlGui", null),
    ...
    GAIN_MODE_GET(0x0A, 0, 2, "Get gain mode", "ThermalCamControlGui", null),
    GAIN_MODE_SET(0x0A, 2, 2, "Set gain mode", "ThermalCamControlGui", null),
    FFC_MODE_SELECT_GET(0x0B, 0, 2, "Get FFC Mode", "ThermalCamControlGui", null),
    FFC_MODE_SELECT_SET(0x0B, 2, 2, "Set FFC Mode", "ThermalCamControlGui", null),
    FFC_INTEG_FRAMES_GET(0x0B, 4, 2, "Get number of integrated frames during FFC", "ThermalCamControlGui", null),
    FFC_INTEG_FRAMES_SET(0x0B, 4, 0, "Set number of integrated frames during FFC", "ThermalCamControlGui", null),
    DO_FFC_AUTO(0x0C, 0, 0, "Auto FFC", "ThermalCamControlGui", null),
    DO_FFC_SPECIFIED(0x0C, 2, 2, "FFC Long or short", "ThermalCamControlGui", null),
    FFC_PERIOD_GET(0x0D, 0, 4, "Get interval between FFC frames for both gain states", "ThermalCamControlGui", null),
    FFC_PERIOD_SET(0x0D, 2, 2, "Set interval between FFC frames for current gain state", "ThermalCamControlGui", null),
    FFC_PERIOD_SPECIFY(0x0D, 4, 4, "Set interval between FFC frames for speific gain states. "
            + "Bytes 0-1 for high gain, 2-3 for low gain", "ThermalCamControlGui", null),
    FFC_TEMP_DELTA_GET(0x0E, 0, 4, "Get temp diff used to trigger auto FFC. Reply bytes "
            + "0-1 for high gain, 2-3 for low gain", "ThermalCamControlGui", null),
    FFC_TEMP_DELTA_SET(0x0E, 2, 2, "Set temp delta value for current gain state", "ThermalCamControlGui", null),
    ...
    EXTERNAL_SYNC_GET(0x21, 0, 2, "Get external sync mode", "ThermalCamControlGui", null),
    EXTERNAL_SYNC_SET(0x21, 2, 2, "Set external sync mode", "ThermalCamControlGui", null),
    ...
    TEST_PATTERN_GET(0x25, 0, 2, "Get the current test pattern", "ThermalCamControlGui", null),
    TEST_PATTERN_SET(0x25, 2, 2, "Set the test pattern", "ThermalCamControlGui", null),
